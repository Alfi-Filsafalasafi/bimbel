...
Public Class report_angsuran
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "bimbel.report_angsuran.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_angsuran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_angsuran = New report_angsuran()
        rpt.Site = Me.Site
        Return rpt
    End Function
