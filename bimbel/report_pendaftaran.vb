...
Public Class report_pendaftaran
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "bimbel.report_pendaftaran.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_pendaftaran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_pendaftaran = New report_pendaftaran()
        rpt.Site = Me.Site
        Return rpt
    End Function
